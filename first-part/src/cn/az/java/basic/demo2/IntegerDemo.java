...
public class IntegerDemo {
    ...
    public static void main(String[] args) {
        ...
        Integer value = 99; // constant
        Integer value2 = new Integer(99);
        Integer value3 = Integer.valueOf(99); // constant
        //Integer.equals比较的是值
        ...
        //答：通过调整java.lang.Integer.IntegerCache.high参数 JAVA_OPTS="-Djava.lang.Integer.IntegerCache.high=50"
