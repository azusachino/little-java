package cn.az.java.hello.proto;
...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<cn.az.java.hello.proto.Request,
      cn.az.java.hello.proto.Response> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = cn.az.java.hello.proto.Request.class,
      responseType = cn.az.java.hello.proto.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<cn.az.java.hello.proto.Request,
      cn.az.java.hello.proto.Response> getSayHelloMethod() {
    io.grpc.MethodDescriptor<cn.az.java.hello.proto.Request, cn.az.java.hello.proto.Response> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<cn.az.java.hello.proto.Request, cn.az.java.hello.proto.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cn.az.java.hello.proto.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cn.az.java.hello.proto.Response.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(cn.az.java.hello.proto.Request request,
        io.grpc.stub.StreamObserver<cn.az.java.hello.proto.Response> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                cn.az.java.hello.proto.Request,
                cn.az.java.hello.proto.Response>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public cn.az.java.hello.proto.Response sayHello(cn.az.java.hello.proto.Request request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<cn.az.java.hello.proto.Response> sayHello(
        cn.az.java.hello.proto.Request request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((cn.az.java.hello.proto.Request) request,
              (io.grpc.stub.StreamObserver<cn.az.java.hello.proto.Response>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cn.az.java.hello.proto.Hello.getDescriptor();
    }
