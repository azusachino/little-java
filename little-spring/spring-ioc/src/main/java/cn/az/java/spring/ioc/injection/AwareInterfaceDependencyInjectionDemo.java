...
public class AwareInterfaceDependencyInjectionDemo implements BeanFactoryAware,
    ...
    public void setApplicationEventPublisher(ApplicationEventPublisher applicationEventPublisher) {
        AwareInterfaceDependencyInjectionDemo.publisher = applicationEventPublisher;
    }

    @Override
    public void setEmbeddedValueResolver(StringValueResolver resolver) {
        AwareInterfaceDependencyInjectionDemo.resolver = resolver;
    }

    @Override
    public void setMessageSource(MessageSource messageSource) {
        AwareInterfaceDependencyInjectionDemo.source = messageSource;
    }
}
